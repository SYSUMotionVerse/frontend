...
export default defineConfig({
  ...
  shortcuts: {
    ...
    // FORM STYLES
    'input-shell': 'w-full box-border rounded-full bg-slate-50 border-[6rpx] border-[#FFEAC2] min-h-[100rpx] px-[32rpx] text-[32rpx] text-[#1A202C] font-700 placeholder:text-[#64748B] transition-[border-color,box-shadow,transform] duration-150',
    'btn-primary': 'w-full min-h-[108rpx] bg-[#C94357] text-white flex items-center justify-center rounded-full shadow-[0_10rpx_0_#9F3041] active:translate-y-1 active:shadow-[0_4rpx_0_#9F3041] transition-[transform,box-shadow,background-color] duration-150 font-900 text-[34rpx] disabled:opacity-50 disabled:shadow-none disabled:translate-y-1',
