  ...
  >
    ...
    >
      <VisualTrainingPanel
        ...
        :pretraining-duration-seconds="session.pretrainingDurationSeconds.value"
        :pretraining-embedded-countdown-duration="session.pretrainingEmbeddedCountdownDuration.value"
